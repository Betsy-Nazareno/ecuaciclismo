...
export const agregarConsejo = async (consejo: Consejo, token: string) => {
  try {
    ...
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/consejodia/new_consejo_dia/`,
...
export const editarConsejo = async (
  ...
  try {
    ...
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/consejodia/update_consejo_dia/`,
...
export const obtenerConsejosActuales = async (token: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/consejodia/get_consejos_dia/`,
      headers: { Authorization: 'Token ' + token },
    })
...
export const obtenerConsejosHistoricos = async (token: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/consejodia/get_historico_consejos_dia/`,
      headers: { Authorization: 'Token ' + token },
    })
    return response.data
  } catch (e) {
...
export const republicarConsejo = async (
  ...
  try {
    const response = await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/consejodia/republicar_consejo_dia/`,
...
export const eliminarConsejo = async (token: string, tokenConsejo: string) => {
  try {
    await axios({
      method: 'DELETE',
      url: `${process.env.BASE_URL}/api/consejodia/delete_consejo_dia/`,
...
export const despinnearConsejo = async (token: string, authtoken: string) => {
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/consejodia/remove_fijar_consejo/`,
      headers: { Authorization: 'Token ' + authtoken },
...
export const pinnearConsejo = async (token: string, authtoken: string) => {
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/consejodia/fijar_consejo/`,
      headers: { Authorization: 'Token ' + authtoken },
      data: { token_consejo: token },
    })
  } catch (e) {
