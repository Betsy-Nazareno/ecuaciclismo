...
export const getLugares = async (token: string) => {
    try {
        const response = await axios({
            method: 'GET',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/get_lugares/',
...
export const new_lugar = async (token: string, lugar: Lugar) => {
    try {
        ...
        const response = await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/new_lugar/',
            headers: { Authorization: 'Token ' + token },
            data: {
                nombre: lugar.nombre,
                ciudad: lugar.ciudad,
...
export const getLugar = async (token: string, tokenLugar: string) => {
    ...
    try {
        const response = await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/get_lugar/',
...
export const getReseñas = async (token: string, tokenLugar: string) => {
    ...
    try {
        const response = await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/get_reseñas/',
            data: { token_lugar: tokenLugar },
            headers: { Authorization: 'Token ' + token }
        })
...
export const new_reseña = async (token: string, token_lugar: string, contenido: string, puntuacion_atencion: number, puntuacion_limpieza: number, puntuacion_seguridad: number) => {
    try {
        await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/new_reseña/',
...
export const update_reseña = async (token: string, token_reseña: string, contenido: string, puntuacion_atencion: number, puntuacion_limpieza: number, puntuacion_seguridad: number) => {
    try {
        await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/edit_reseña/',
...
export const delete_reseña = async (token: string, token_reseña: string) => {
    try {
        await axios({
            method: 'POST',
            url: 'https://fa94-157-100-104-212.ngrok-free.app/api/lugar/delete_reseña/',
