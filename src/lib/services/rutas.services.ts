...
export const getRequisitos = async (authToken: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/ruta/get_requisitos/`,
...
export const getTiposRuta = async (authToken: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/ruta/get_tipos_rutas/`,
      headers: { Authorization: 'Token ' + authToken },
    })
...
export const getColaboracionesRutas = async (authToken: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/ruta/get_colaboraciones/`,
      headers: { Authorization: 'Token ' + authToken },
    })
...
export const getGruposEncuentro = async (authToken: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/ruta/get_grupos_encuentro/`,
      headers: { Authorization: 'Token ' + authToken },
    })
...
export const getAllRutas = async (authToken: string) => {
  try {
    const response = await axios({
      method: 'GET',
      url: `${process.env.BASE_URL}/api/ruta/get_rutas/`,
      headers: { Authorization: 'Token ' + authToken },
    })
...
export const guardarRuta = async (authToken: string, ruta: Ruta) => {
  try {
    ...
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/new_ruta/`,
      data: {
        ...ruta,
        fotos,
...
export const editarRuta = async (
  ...
  try {
    ...
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/editar_ruta/`,
      data: {
        ...ruta,
...
export const getRutaById = async (authToken: string, tokenRuta: string) => {
  ...
  try {
    const response = await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/get_ruta/`,
...
export const aprobarRuta = async (authToken: string, tokenRuta: string) => {
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/aprobar_ruta/`,
      data: { token_ruta: tokenRuta },
      headers: {
        Authorization: 'Token ' + authToken,
        'Content-Type': 'application/json',
...
export const eliminarRuta = async (authToken: string, tokenRuta: string) => {
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/eliminar_ruta/`,
      data: { token_ruta: tokenRuta },
      headers: {
        Authorization: 'Token ' + authToken,
        'Content-Type': 'application/json',
...
export const inscribirUsuarioEnRuta = async (
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/inscribirse_ruta/`,
...
export const cancelarInscripcionUsuario = async (
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/cancelar_inscripcion/`,
...
export const cancelarRutas = async (
  ...
  try {
    await axios({
      method: 'POST',
      url:`${process.env.BASE_URL}/api/ruta/cancelar_ruta/`,
...
export const finalizarRutaAdmin = async (
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/finalizar_ruta/`,
      data: { token_ruta: tokenRuta },
      headers: {
        Authorization: 'Token ' + authToken,
        'Content-Type': 'application/json',
...
export const finalizarRastreo = async (
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/finalizar_rastreo/`,
...
export const getDatosRastreoById = async (
  ...
  try {
    const response = await axios({
      ...
      url: `${process.env.BASE_URL}/api/ruta/get_informacion_individual_ruta/`,
      headers: { Authorization: 'Token ' + authToken },
    })
...
export const enviarComentariosRuta = async (
  ...
  try {
    await axios({
      method: 'POST',
      url: `${process.env.BASE_URL}/api/ruta/adicional_rastreo/`,
